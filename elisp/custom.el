...
(custom-set-faces
 ...
 '(fixed-pitch ((t (:family "Fira Code" :foundry "outline" :slant normal :weight normal :height 102 :width normal))))
 '(variable-pitch ((t (:family "Sans Serif" :slant normal :weight light :height 102 :width normal))))
